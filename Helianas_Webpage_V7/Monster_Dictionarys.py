...
aberation = {'Antenna':5,'Eye':5,'Flesh':5,'Phial of blood':5,'Bone':10,'Egg':10,'Fat':10,'Pouch of claws':10,'Pouch of teeth':10,'Heart':15,'Phial of mucus':15,'Liver':15,'Stinger':15,'Tentacle':15,'Brain':20,'Chitin':20,'Hide':20,'Main eye':20,'Essence':'Unknown'}
beast = {'Antenna':5,'Eye':5,'Flesh':5,'Phial of blood':5,'Antler':10,'Beak':10,'Bone':10,'Egg':10,'Fat':10,'Fin':10,'Horn':10,'Pincer':10,'Pouch of claws':10,'Pouch of teeth':10,'Talon':10,'Tusk':10,'Heart':15,'Liver':15,'Poison gland':15,'Pouch of feathers':15,'Pouch of scales':15,'Stinger':15,'Tentacle':15,'Chitin':20,'Pelt':20,'Essence':'Unknown'}
celestial = {'Eye':5,'Flesh':5,'Phial of Blood':5,'Pouch of Dust':5,'Bone':10,'Fat':10,'Horn':10,'Pouch of Teeth':10,'Heart':15,'Liver':15,'Pouch of Feathers':15,'Pouch of Scales':15,'Brain':20,'Skin':20,'Soul':25,'Essence':'Unknown'}
construct = {'Phial of Blood':5,'Phial of Oil':5,'Phial of Sap':5,'Pouch of Dust':5,'Flesh':10,'Metal Plating':10,'Stone':10,'Bone':15,'Heart':15,'Liver':15,'Gears':15,'Brain':20,'Instructions':20,'Lifespark':25,'Essence':'Unknown'}
dragon = {'Eye':5,'Flesh':5,'Phial of Blood':5,'Bone':10,'Fat':10,'Pouch of Claws':10,'Pouch of Teeth':10,'Horn':15,'Liver':15,'Pouch of Scales':15,'Heart':20,'Breath Sac':25,'Essence':'Unknown'}
elemental = {'Eye':5,'Primordial Dust':5,'Bone':10,'Volatile Mote of Air':15,'Volatile Mote of Earth':15,'Volatile Mote of Fire':15,'Volatile Mote of Water':15,'Core of Air':25,'Core of Earth':25,'Core of Fire':25,'Core of Water':25,'Essence':'Unknown'}
fey = {'Antenna':5,'Eye':5,'Flesh':5,'Phial of Blood':5,'Antler':10,'Beak':10,'Bone':10,'Egg':10,'Horn':10,'Pouch of Claws':10,'Pouch of Teeth':10,'Talon':10,'Tusk':10,'Heart':15,'Fat':15,'Liver':15,'Poison Gland':15,'Pouch of Feathers':15,'Pouch of Scales':15,'Tentacle':15,'Tongue':15,'Brain':20,'Skin':20,'Pelt':20,'Psyche':25,'Essence':'Unknown'}
fiend = {'Antenna':5,'Eye':5,'Flesh':5,'Phial of Blood':5,'Pouch of Dust':5,'Bone':10,'Horn':10,'Pouch of Teeth':10,'Heart':15,'Fat':15,'Liver':15,'Poison Gland':15,'Pouch of Feathers':15,'Pouch of Scales':15,'Brain':20,'Skin':20,'Soul':25,'Essence':'Unknown'}
giant = {'Flesh':5,'Nail':5,'Phial of Blood':5,'Bone':10,'Fat':10,'Tooth':10,'Heart':15,'Liver':15,'Skin':20,'Essence':'Unknown'}
